...
public class CustomOAuth2UserService extends DefaultOAuth2UserService {
    ...
    public OAuth2User loadUser(OAuth2UserRequest oAuth2UserRequest) throws OAuth2AuthenticationException {
        ...
        upsertUser(oAuth2UserRequest, oAuth2User);
        return oAuth2User;
    }

    private void upsertUser(OAuth2UserRequest oAuth2UserRequest, OAuth2User oAuth2User) {
    ...
    private void insertNewUser(OAuth2UserRequest oAuth2UserRequest, OAuth2UserInfo oAuth2UserInfo) {
        User user = new User();
